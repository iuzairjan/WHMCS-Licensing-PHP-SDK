<?php
function validate_license($licensekey, $localkey='') {

    $whmcsurl = 'https://yourwhmcsdomain.com/';
    $licensing_secret_key = 'YOURSECRET';
    $localkeydays = 15;
...
$licensekey = trim(file_get_contents($license_file));
$localkey = '';

// Validate the license key information
$results =  validate_license($licensekey, $localkey);
